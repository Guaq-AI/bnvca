        ...
        <div className="container mx-auto px-6 md:px-12 relative z-20">
          ...
          >
            ...
            <h1 className="text-7xl md:text-9xl lg:text-[11rem] font-serif leading-[0.8] tracking-tighter text-foreground mb-12">
              Expertise & <br /><span className="text-primary/20 italic font-light">Excellence.</span>
            </h1>
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center`}>
                  ...
                  >
                    <div className="bg-foreground/[0.02] border border-foreground/5 p-12 md:p-16 relative overflow-hidden group">
                      ...
                      <h3 className="text-[10px] font-sans uppercase tracking-[0.3em] text-foreground/30 mb-12 font-bold">CORE OFFERINGS</h3>
